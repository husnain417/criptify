              ...
              <div className="col-xl-6 col-lg-10">
                <div className="hero-style3">
                  ...
                  <h1
                    ...
                    data-wow-delay=".4s"
                  >
                      <span className="title1">Unlock</span>
                      <br></br>
                      <span className="title2">Crypto Insights &<br></br></span>
                      <span className="title3">Boost Your Earnings</span>
                  </h1>
                  <div
                  ...
                  >
                    <ul className="ps-0">
                      ...
                      <li className="text-white">
                        Gain exclusive access to crypto airdrops and profit-boosting guides.
                      </li>
                    </ul>
                    <ul className="ps-0">
                      <li>
                      ...
                      <li className="text-white">
                        Join a trusted community of crypto enthusiasts around the globe.
                      </li>
                    </ul>
                  </div>
                  <div
