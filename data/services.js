...
export const services3 = [
  {
    ...
    title: "Exclusive Crypto Airdrops",
    description:
      "Get access to exclusive crypto airdrops that can boost your portfolio and give you a head start in the crypto world. Our landing page connects you to the latest airdrop opportunities.",
    delay: ".2s",
  },
  {
    id: 19,
    icon: "/assets/img/icon/serviceIcon4_2.png",
    title: "Easy to Use & Customizable",
    description:
      "Our platform offers easy customization, allowing users to personalize their experience and receive crypto-related content that matches their interests and needs. Whether you're new or experienced in crypto, the platform adapts to you.",
    delay: ".5s",
  },
  {
    id: 20,
    ...
    description:
      "Our support team is available 24/7 to assist you with any crypto-related queries or issues. Whether you need help navigating the platform, claiming rewards, or understanding the latest trends, we are here to provide quick and helpful assistance.",
    delay: ".8s",
  },
];
